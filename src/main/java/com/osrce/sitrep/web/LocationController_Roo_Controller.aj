...
import com.osrce.sitrep.web.LocationController;
...
privileged aspect LocationController_Roo_Controller {
    ...
    void LocationController.addDateTimeFormatPatterns(Model uiModel) {
        ...
        uiModel.addAttribute("location_updated_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
